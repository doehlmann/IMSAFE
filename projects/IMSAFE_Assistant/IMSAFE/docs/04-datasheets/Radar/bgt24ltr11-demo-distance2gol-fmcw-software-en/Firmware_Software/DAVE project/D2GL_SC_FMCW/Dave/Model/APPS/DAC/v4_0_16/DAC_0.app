...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="DAC" URI="http://resources/4.0.16/app/DAC/0" description="Generates Pattern, Noise and Ramp waveform.&#xA; It can be used for single value and data processing modes." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.0.0" instanceLabel="DAC_VTune" appLabel="">
  ...
  <hwResources name="Pin" URI="http://resources/4.0.16/app/DAC/0/__pin_hwres_dac_analogpin" resourceGroupUri="devicepackage/0/n5" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.16/app/DAC/0/http://resources/4.0.16/app/DAC/0/vs_dac_sr/http://resources/4.1.8/app/DMA_CH/3/dst_peri_trig" sourceSignal="event_ch_sr" targetSignal="destination_trigger" srcVirtualSignal="//@virtualSignals.3">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../DMA_CH/v4_1_8/DMA_CH_3.app#//@virtualSignals.5"/>
    <targetVirtualSignal href="../../DMA_CH/v4_1_8/DMA_CH_3.app#//@virtualSignals.5"/>
  </connections>
</ResourceModel:App>
