/*
 ...
 @brief: This file defines the driver API for Distance2GoL Board of
...
#define RADAR_ERR_SIZE_MISMATCH               0x0053  /**< message size mismatch. */
 ...
 *                                                      it's in test mode)
 */
uint16_t radar_start_frame_timer(Radar_Handle_t device,
 ...
 *
 * \param[in] device              A handle to the radar sensor device.
 * \param[in]  chirp_time_usec    An unsigned 32-bit value, in units of usec,
 * 								  which should be within the limits of \ref MIN_CHIRP_TIME_USEC & \ref MIN_CHIRP_TIME_USEC.
 *
 * \return One of the following status can be return:
 *   	   - \ref RADAR_STATUS_SUCCESS	Success
 *   	   - \ref RADAR_STATUS_FAIL    	Fail
