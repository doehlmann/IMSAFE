...
#define     RF_BOARD_ID                          "RBBSFV30"   /* The RF board ID, it used to identify the RF board and to run the FW accordingly
...
#define 	DS_EEPROM_ADRESS_DEFAULT_SETTING	 0xE0U			/* Read/Write default settings check, only one page*/
