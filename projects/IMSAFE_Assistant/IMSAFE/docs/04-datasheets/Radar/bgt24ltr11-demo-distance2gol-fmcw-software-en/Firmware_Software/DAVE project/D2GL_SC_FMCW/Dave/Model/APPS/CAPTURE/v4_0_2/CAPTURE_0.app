...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CAPTURE" URI="http://resources/4.0.2/app/CAPTURE/0" description="Perform signal analysis to find out the duty cycle and the period of an unknown input signal." mode="NOTSHARABLE" version="4.0.2" minDaveVersion="4.2.4" instanceLabel="CAPTURE_COUNTER_PERIOD" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="capture_pad" URI="http://resources/4.0.2/app/CAPTURE/0/vs_capture_input" hwSignal="pad" hwResource="//@hwResources.2" required="false"/>
  <virtualSignals name="capture_input" URI="http://resources/4.0.2/app/CAPTURE/0/vs_ccu4_cc4_gp0_unsync" hwSignal="gp0_unsync" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../CCU4_SLICE_CONFIG/v4_0_18/CCU4_SLICE_CONFIG_0.app#//@connections.3"/>
  </virtualSignals>
  <virtualSignals name="capture_input" URI="http://resources/4.0.2/app/CAPTURE/0/vs_ccu8_cc8_gp0_unsync" hwSignal="gp0_unsync" hwResource="//@hwResources.1" visible="true"/>
  ...
  <hwResources name="Capture Input Pin" URI="http://resources/4.0.2/app/CAPTURE/0/hwres_port_pad_capture_in" resourceGroupUri="" required="false" mResGrpUri="port/p/*/pad/*"/>
  ...
  <hwResources name="Capture Input Pin" URI="http://resources/4.0.2/app/CAPTURE/0/__pin_hwres_port_pad_capture_in" resourceGroupUri="" required="false" mResGrpUri="devicepackage/0/*"/>
  <connections URI="http://resources/4.0.2/app/CAPTURE/0/http://resources/4.0.2/app/CAPTURE/0/vs_global_ccu4_enable/http://resources/4.0.2/app/CAPTURE/0/vs_capture_ccu4_global_enable" systemDefined="true" sourceSignal="ccu4_global" targetSignal="global_enable" targetVirtualSignal="//@virtualSignals.0" proxySrcVirtualSignalUri="http://resources/4.1.12/app/GLOBAL_CCU4/1/vs_global_ccu4_globalsignal" containingProxySignal="true">
